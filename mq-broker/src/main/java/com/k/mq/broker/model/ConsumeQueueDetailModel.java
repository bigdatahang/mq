...
import static com.k.mq.broker.util.ByteConvertUtil.bytesToInt;
import static com.k.mq.broker.util.ByteConvertUtil.readInPos;
...
public class ConsumeQueueDetailModel {
    ...
    public void readFromBytes(byte[] source) {
        this.commitLogFileName = bytesToInt(readInPos(source, 0, 4));
        this.msgIndex = bytesToInt(readInPos(source, 4, 4));
        this.msgLength = bytesToInt(readInPos(source, 8, 4));
    }
