...
public class MMapUtil {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println("请输入需要映射的size:");
        int size = scanner.nextInt();
        MMapUtil mmapUtil = new MMapUtil();
        mmapUtil.loadFileInMMap("/Users/yihang07/code/mq/broker/store/order_topic/00000000", 0, 1024 * 1024 * size);
        System.out.println("映射了" + size + "m的内存");
